...
/**
 * Parts of the 3x3 PC setup: desk row (3 blocks) + 3x2 monitor video wall.
 * dx = offset along the placed axis (facing.rotateYClockwise), +1 = viewer-left.
 * dy = rows above the desk (desk = 0, bottom monitor row = 1, top = 2).
 */
public enum PcWallPart implements StringIdentifiable {
    ...
    /** UV row of the shared wall texture: 0 = top, 1 = bottom. Monitors only. */
    public int uvRow() { return 2 - dy; }
}
